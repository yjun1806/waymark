...
설치하면 Waymark 스킬(`waymark-init`·`waymark-work`·`waymark-update`·`waymark-remove`)과 `/work-new` 명령이 활성화된다.
...
플러그인 구성: `commands/`(슬래시 명령) · `skills/`(`waymark-init`·`waymark-work`·`waymark-update`·`waymark-remove`) ·
